      ...
      <div id="main3">
        <div id="con">
          <div id="content">
            ...
            <div id="right"> <h2 class="style2" >View All  Non-Similar Images  based on different Hash_Sign<span class="style1"></span></h2>
              <div class="flt" style="width:590px;padding:15px 0px 0px 7px;"> 
				...
				String str = "Select * from image_details order by rank desc";
				Statement st = connection.createStatement();
				ResultSet rs = st.executeQuery(str);
				while(rs.next())
				{
				title = rs.getString(2);
				hash_Code = rs.getString(3);
				name = rs.getString(4);
