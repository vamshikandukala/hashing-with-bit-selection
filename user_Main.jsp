          ...
          <div id="content">
            <div id="left"> <h2 class="style1">Sidebar Menu</h2>
              <div class="flt" style="width:260px;padding:15px 0px 0px 9px;"> 
			    ...
			    <li><a href="user_Profile.jsp"style="color:#DD5411;">My Profile</a></li></br>
			    <li><a href="user_Image_Search.jsp"style="color:#DD5411;">Search Images</a></li>
			    </br>
				<li><a href="user_Search_Transaction.jsp"style="color:#DD5411;">My Search Transaction</a></li></br>
