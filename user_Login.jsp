          ...
          <div id="content">
            <div id="left"> <h2 class="style1">Sidebar Menu</h2>
              <div class="flt" style="width:260px;padding:15px 0px 0px 9px;"> 
			    ...
			    <li><a href="user_Login.jsp"style="color:#DD5411;">USER</a> </li></br>
			    <li><a href="project_Details.html"style="color:#DD5411;">ABOUT PROJECT </a> </li></br>
                <p>&nbsp;</p>
            ...
            <div id="right"> <h2 class="style2" >User  Login  Page...! <img src="images/Login.png" width="105" height="150" /></h2>
        	...
        	<table width="313" border="0" align="center">
              ...
              <tr>
                ...
                <p align="right" class="style3">New <a href="user_Register.jsp">Register</a></p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
