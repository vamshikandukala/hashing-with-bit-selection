...
<a href="project_Details.html"></a> </div>
      ...
      <div id="main3">
        <div id="con">
          <div id="content">
            ...
            <div id="right"> <h2 class="style2" >Search Image <span class="style1"><%=request.getParameter("name")%></span> Details </h2>
      	...
      	try 
	{
	       ...
	       String strDate="",strTime="",dt="";
			...
			searched_Type = request.getParameter("searched_Type");
	...
	if ( rs.next() )
	   {
	    ...
	    String str2 = "insert into search (user,title,i_name,searched_type,type_used,dt) values('"+user+"','"+Decrypted_Title+"','"+name+"','"+searched_Type+"','"+type+"','"+dt+"')";
		connection.createStatement().executeUpdate(str2);
		
		String str3 = "update image_details set rank="+rank1+" where name='"+name1+"' ";
...
%>
 ...
 <table border="1" align="center" cellpadding="0" cellspacing="0" >
				 				<tr >
								  ...
								  <div align="center" class="style6"><span class="style17" style="color:#f69722">Title</span> </div></td>
							      <td width="179"><div align="center" class="style7"><span class="style17"><%= Decrypted_Title%></span></div></td>
		  						<tr/>
				    
				    
				    			<tr>
									<td width="163" height="35">
						  		  <div align="center" class="style6"><span class="style17" style="color:#f69722">Image Name</span> </div></td>
								    <td><div align="center" class="style7"><span class="style17"><%= name%></span></div></td>
								</tr>
								<tr>
									<td width="163" height="35">
								  <div align="center" class="style6"><span class="style17" style="color:#f69722">color </span> </div></td>
								    <td><div align="center" class="style7"><span class="style17"><%=color%></span></div></td>
				    			</tr>
								<tr>
										<td width="163" height="35">
								  <div align="center" class="style6"><span class="style17" style="color:#f69722">Uses</span></div></td>
								        <td><div align="center" class="style7"><span class="style17"><%= Decrypted_Uses%></span></div></td>
								</tr>
								<tr>
										<td width="163" height="50">
								  <div align="center" class="style6"><span class="style17" style="color:#f69722">Image_Description</span></div></td>
								        <td><div align="center" class="style7"><span class="style17"><%= Decrypted_Desc%></span></div></td>
								</tr>
								<tr>
										<td width="163" height="35">
								  <div align="center" class="style6"><span class="style17" style="color:#f69722">Rank</span></div></td>
								        <td><div align="center" class="style7"><span class="style17"><%=rank%></span></div></td>
								</tr>
				</table>
						...
						connection.close();
						if(searched_Type.equals("Content Search"))
						{
						%><p align="right" class="style3"><a href="user_Image_Search_Cont.jsp">Back</a></p><%
						}
						else
						{
						%><p align="right" class="style3"><a href="user_Image_Search_Img.jsp">Back</a></p><%
						}
