...
<head>
<title>User Search By Image</title>
      ...
      <div id="main3">
        <div id="con">
          <div id="content">
            ...
            <div id="right"> <h2 class="style2" >Search By Image_Name </h2>
              <div class="flt" style="width:590px;padding:15px 0px 0px 7px;"> 
               ...
               <p>
			    <DIV CLASS="article">
              <H2>&nbsp;</H2>
            <FORM ACTION="user_Image_Search_Img.jsp" METHOD="post">
                  ...
                  <input type="file" id="pic" name="pic" class="text" />
                    ...
                    <TR>
                      <TD COLSPAN="3"><div class="style2">
                        <div align="center" class="style13">( searching Image_Details Based on Hashing of the image groups)</div>
                      </div></TD>
                    </TR>
                  </TABLE>
                </DIV>
...
<%@ page import="java.util.Random,java.io.PrintStream, java.io.FileOutputStream, java.io.FileInputStream, java.security.DigestInputStream, java.math.BigInteger, java.security.MessageDigest, java.io.BufferedInputStream" %>
                  <%
							try
							{
								...
								String title="",Encoded_Title="",img_file="",name="",Decoded_Name="",rank="",color="",color1="",title1="",Decoded_Title="";
								String input= request.getParameter("pic");	
								
								   
								%>
                <p class="style6">Searched Image  Based on Hashing:<span class="style1"> <%=input%></span></p>
                  <%   
								...
								while(rs.next())
								{
								   ...
								   img_file = rs1.getString(8);
								   
								  
								   
								   
								
									if ( img_file.equals(input) && count==1)
									{
									
								     count=count+1;
									 String str2 = "select * from image_details where color='"+color+"' order by rank desc";
									 Statement st2 = connection.createStatement();
									 ResultSet rs2 = st2.executeQuery(str2);
									 while (rs2.next())
									 {
									 title1 = rs2.getString(2);
									 name = rs2.getString(4);
									 color1 = rs2.getString(5);
									 rank = rs2.getString(10);
									 Decoded_Title = new String(Base64.decode(title1.getBytes()));
									 Decoded_Name = new String(Base64.decode(name.getBytes()));
								
							         %>
									<tr>
									<td>
									<a class="#" id="img1" href="user_Image_Details.jsp?name1=<%=name%>&name=<%=Decoded_Name%>&searched_Type=<%="Image Search"%>&type=<%=input%>" >
